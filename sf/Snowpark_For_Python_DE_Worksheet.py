...
def main(session: snowpark.Session): 
    ...
    # It represents a lazily-evaluated relational dataset that contains 
    # a collection of Row objects with columns defined by a schema 
    # (column name and type). Here are some of the ways to load data 
    # in a Snowpark DataFrame are:
